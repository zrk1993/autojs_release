  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" prop="create_time" label="下次执行时间">
        <template slot-scope="scope">
          <span>{{ scope.row.next_execute_time }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" prop="device_ids" label="设备分组">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.device_ids && scope.row.device_ids != 0" type="success">{{ scope.row.device_category }}</el-tag>
