  ...
  <div class="dialog">
    <div class="dialog-cont">
      ...
      <div class="m10">
        ...
        <el-checkbox v-model="checked">号码自动加+86</el-checkbox>
      </div>
      <div class="m10">共发现号码{{ list.length }}个</div>
    </div>
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      if (this.checked) {
        this.list.forEach(i => (i.phone = '+86' + i.phone));
      }
      request({
        url: "/sms/phone/add",
        method: "post",
    ...
    upload() {
      ...
      reader.onload = function() {
        ...
        list = list.filter(i => i.phone && i.phone.length > 5);
        that.list = list;
      };
